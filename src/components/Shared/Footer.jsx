...
const Footer = () => {
  ...
  <div>
    ...
    <a className="link link-hover">Phone: 01794019401</a> 
    <a className="link link-hover">Email: enamul9401@gmail.com</a> 
    <a className="link link-hover">Address: Paikgaca, Khulna</a>
  </div>
</footer> 
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <div className="items-center grid-flow-col">
    <img className='h-12 rounded-full pr-2' src={logo} />
    <p className='text-lg font-bold'>Toy Market</p>
  </div>
  <div>
  <p className='font-semibold'>Copyright © 2023 - All right reserved by Toy Market</p>
    </div> 
</footer>
        </div>
    );
